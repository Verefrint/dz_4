...
export class DimaToken extends ethereum.SmartContract {
  static bind(address: Address): DimaToken {
    return new DimaToken("DimaToken", address);
  }
...
export class ChangePriceForMintCall extends ethereum.Call {
  get inputs(): ChangePriceForMintCall__Inputs {
    return new ChangePriceForMintCall__Inputs(this);
  }

  get outputs(): ChangePriceForMintCall__Outputs {
    return new ChangePriceForMintCall__Outputs(this);
  }
}

export class ChangePriceForMintCall__Inputs {
  _call: ChangePriceForMintCall;

  constructor(call: ChangePriceForMintCall) {
    this._call = call;
  }
...
export class ChangePriceForMintCall__Outputs {
  _call: ChangePriceForMintCall;
